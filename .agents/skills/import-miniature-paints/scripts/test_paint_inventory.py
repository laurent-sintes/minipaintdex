...
MODULE_PATH = Path(__file__).with_name("paint_inventory.py")
SPEC = importlib.util.spec_from_file_location("paint_inventory", MODULE_PATH)
paint_inventory = importlib.util.module_from_spec(SPEC)
assert SPEC and SPEC.loader
SPEC.loader.exec_module(paint_inventory)
