...
public record SearchMarketPaintsQuery(
    ...
    public SearchMarketPaintsQuery {
    ...
    public static SearchMarketPaintsQuery fromSelections(
        ...
        return new SearchMarketPaintsQuery(query, brand, values(range).stream().map(PaintRangeSelection::parse).toList(),
