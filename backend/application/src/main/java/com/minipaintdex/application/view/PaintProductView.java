...
public record PaintProductView(
        String id,
        String brand,
        String manufacturer,
        ...
        List<CatalogMembership> catalogMemberships, List<String> usageGuideIds) {

    public PaintProductView {
        ...
        usageGuideIds = List.copyOf(usageGuideIds);
    }
